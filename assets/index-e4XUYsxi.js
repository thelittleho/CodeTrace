const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NoteEditor-jP1ENRhH.js","assets/markdown-BcSvwfSh.js","assets/NoteEditor-Dpj7L23U.css","assets/GithubExplorer-BT5tm0s-.js","assets/GithubExplorer-BdtmGDCU.css"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lT{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(uT(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function uT(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const vc="@firebase/app",Oh="0.14.11";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function YT(n){ts(new wr("platform-logger",e=>new lT(e),"PRIVATE")),ts(new wr("heartbeat",e=>new WT(e),"PRIVATE")),Hn(vc,Oh,n),Hn(vc,Oh,"esm2020"),Hn("fire-js","")}YT("");var XT="firebase",ZT="12.12.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ro=new ul("@firebase/auth");function tI(n,...e){Ro.logLevel<=ue.WARN&&Ro.warn(`Auth (${us}): ${n}`,...e)}function io(n,...e){Ro.logLevel<=ue.ERROR&&Ro.error(`Auth (${us}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ic(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.href)||""}function rI(){return Uh()==="http:"||Uh()==="https:"}function Uh(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Co(n){var p;const e=n.auth,t=await n.getIdToken(),r=await ci(n,Po(e,{idToken:t}));te(r==null?void 0:r.users.length,e,"internal-error");const s=r.users[0];n._notifyReloadListener(s);const i=(p=s.providerUserInfo)!=null&&p.length?vp(s.providerUserInfo):[],a=gI(n.providerData,i),c=n.isAnonymous,l=!(n.email&&s.passwordHash)&&!(a!=null&&a.length),h=c?l:!1,d={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new wc(s.createdAt,s.lastLoginAt),isAnonymous:h};Object.assign(n,d)}async function mI(n){const e=ut(n);await Co(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function gI(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function vp(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Np{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(Vo,"1"),this.storage.removeItem(Vo),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sl=-1;function oa(n){return n==null}function No(n){return n===0&&1/n==-1/0}function EA(n){return typeof n=="number"&&Number.isInteger(n)&&!No(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nm="server_timestamp",rm="__type__",sm="__previous_value__",im="__local_write_time__";function Rl(n){var t,r;return((r=(((t=n==null?void 0:n.mapValue)==null?void 0:t.fields)||{})[rm])==null?void 0:r.stringValue)===nm}function aa(n){const e=n.mapValue.fields[sm];return Rl(e)?aa(e):e}function ui(n){const e=Qn(n.mapValue.fields[im].timestampValue);return new Ve(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dl(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:No(e)?"-0":e}}function Em(n){return{integerValue:""+n}}function JA(n,e){return EA(e)?Em(e):Dl(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ha{constructor(){this._=void 0}}function YA(n,e,t){return n instanceof Fo?function(s,i){const a={fields:{[rm]:{stringValue:nm},[im]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&Rl(i)&&(i=aa(i)),i&&(a.fields[sm]=i),{mapValue:a}}(t,e):n instanceof os?Im(n,e):n instanceof as?wm(n,e):function(s,i){const a=Tm(s,i),c=Ef(a)+Ef(s.Ae);return Pc(a)&&Pc(s.Ae)?Em(c):Dl(s.serializer,c)}(n,e)}function XA(n,e,t){return n instanceof os?Im(n,e):n instanceof as?wm(n,e):t}function Tm(n,e){return n instanceof Uo?function(r){return Pc(r)||function(i){return!!i&&"doubleValue"in i}(r)}(e)?e:{integerValue:0}:null}class Fo extends ha{}class os extends ha{constructor(e){super(),this.elements=e}}function Im(n,e){const t=Am(e);for(const r of n.elements)t.some(s=>rn(s,r))||t.push(r);return{arrayValue:{values:t}}}class as extends ha{constructor(e){super(),this.elements=e}}function wm(n,e){let t=Am(e);for(const r of n.elements)t=t.filter(s=>!rn(s,r));return{arrayValue:{values:t}}}class Uo extends ha{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function Ef(n){return Le(n.integerValue||n.doubleValue)}function Am(n){return Pl(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
### 🔗 참고 자료
- 
`}},kR=n=>{const t=new DOMParser().parseFromString(n,"text/html"),r=t.querySelector(".problem-title")||t.querySelector("h1")||t.querySelector(".main h1")||t.querySelector(".page-header h1");let s=r?r.textContent.trim():"제목 없음",i="";const a=t.getElementById("pro1")||t.querySelector(".problem-description")||t.querySelector("#problem_description");if(a)i=Bc(a);else{const l=t.querySelector(".main")||t.querySelector("#main");l&&(i=Bc(l))}return{title:s,content:i+`
...
### 🔗 참고 자료
- 
`}},Bc=n=>{const e=t=>{if(t.nodeType===3)return t.textContent;if(t.nodeType!==1)return"";const r=t.nodeName,s=t.textContent.trim();if(s==="문제 설명"||s==="문제설명")return"";switch(r){case"H1":return`
# ${s}
`;case"H2":return`
## ${s}
